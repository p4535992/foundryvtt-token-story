...
import { TOKEN_STORY_MODULE_NAME } from './module/settings';
...
export const debug = (...args) => {
  if (debugEnabled > 1) console.log(`DEBUG:${TOKEN_STORY_MODULE_NAME} | `, ...args);
};
export const log = (...args) => console.log(`${TOKEN_STORY_MODULE_NAME} | `, ...args);
export const warn = (...args) => {
  if (debugEnabled > 0) console.warn(`${TOKEN_STORY_MODULE_NAME} | `, ...args);
};
export const error = (...args) => console.error(`${TOKEN_STORY_MODULE_NAME} | `, ...args);
export const timelog = (...args) => warn(`${TOKEN_STORY_MODULE_NAME} | `, Date.now(), ...args);
...
Hooks.once('init', async () => {
  console.log(`${TOKEN_STORY_MODULE_NAME} | Initializing ${TOKEN_STORY_MODULE_NAME}`);
